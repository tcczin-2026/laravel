                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <dl class="row mb-4">
                            ...
                            <dt class="col-sm-4">Leitor (Digital)</dt>
                            <dd class="col-sm-8">{{ $console->digital->nome ?? '-' }}</dd>
                            ...
                            <dt class="col-sm-4">Desbloqueado</dt>
                            <dd class="col-sm-8">{{ $console->desbloqueado->nome ?? '-' }}</dd>

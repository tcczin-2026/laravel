...
return new class extends Migration
{
    ...
    {
        Schema::create('acessorio_historico', function (Blueprint $table) {
            $table->id();

            // Liga cada linha do histórico ao acessorio que sofreu a alteração.
            // onDelete('cascade'): se o acessorio for apagado de vez do banco,
            // o histórico dele some junto (evita registro "órfão").
            // Obs: assumindo que a tabela se chama "acessorio", seguindo o
            // mesmo padrão sem plural das outras tabelas do projeto.
            $table->foreignId('acessorio_id')->constrained('acessorio')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('acessorio_historico');
    }
};
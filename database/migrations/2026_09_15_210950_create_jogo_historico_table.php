...
return new class extends Migration
{
    ...
    {
        Schema::create('jogo_historico', function (Blueprint $table) {
            $table->id();

            // Liga cada linha do histórico ao jogo que sofreu a alteração.
            // onDelete('cascade'): se o jogo for apagado de vez do banco,
            // o histórico dele some junto (evita registro "órfão").
            // Obs: assumindo que a tabela se chama "jogo", seguindo o
            // mesmo padrão sem plural das outras tabelas do projeto.
            $table->foreignId('jogo_id')->constrained('jogo')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('jogo_historico');
    }
};